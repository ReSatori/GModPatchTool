...
const TEXT_SERVER_ROOTS: [&str; 1] = [
	"https://gh.momoka.tech/gh-proxy/https://raw.githubusercontent.com/solsticegamestudios/GModPatchTool/refs/heads/files/"
];

// Patch files
const BINARY_SERVER_ROOTS: [&str; 1] = [
	"https://gh.momoka.tech/gh-proxy/https://media.githubusercontent.com/media/solsticegamestudios/GModPatchTool/refs/heads/files/"
];
